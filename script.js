...
function halfx(){
  var halfresult = document.getElementById("half").value;
...
function restyle(){
  ...
  selected.style.fontSize = font + "px";
  selected.style.color =r "rgb(" + color1 + "," + color2 + "," + color3 + ")";
  selected.style.background = "rgb(" + elBack + ")";
